...
# Declara la variable
carpeta_entrada = r"D:\shapes quito\VolumenArenas\prueba_fill\splitArenas1"
...
archivoSalida = open("D:\shapes quito\VolumenArenas\prueba_fill\salidaVolumenes\salidaVolRaster1.txt", "a")
