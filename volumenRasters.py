...
# Declara la variable
carpeta_entrada = r"D:\ArcPRO\ejemplo\ImportLog24"
...
archivoSalida = open("D:\ArcPRO\ejemplo\salidaVolumen\salidaVolRaster24.txt", "a")
...
for a in datosRaster:
    ...
    textoSalida = r"D:\ArcPRO\ejemplo\salidaVolumen" + "//" + a + ".txt"
